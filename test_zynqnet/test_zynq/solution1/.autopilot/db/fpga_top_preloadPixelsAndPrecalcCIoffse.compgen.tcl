...
set id 2
set name fpga_top_mul_16s_2ns_16_3
...
set id 5
set name fpga_top_mul_10ns_10ns_19_3
set corename simcore_mul
set op mul
set stage_num 3
set max_latency 3
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ImageCache_IBRAM_address0 { O 15 vector } ImageCache_IBRAM_ce0 { O 1 bit } ImageCache_IBRAM_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ci_V_out \
    op interface \
    ports { ci_V_out_din { O 10 vector } ci_V_out_full_n { I 1 bit } ci_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ch_out_V_out \
    op interface \
    ports { ch_out_V_out_din { O 10 vector } ch_out_V_out_full_n { I 1 bit } ch_out_V_out_write { O 1 bit } } \
} "
}
