...
set IPName      "fpga_top"
set Version     "1.0"
set DisplayName "Fpga_top"
set Revision    "1905290049"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 SHARED_DRAM W 0x0 "Data signal of SHARED_DRAM" {{0 32 SHARED_DRAM W 0 "Bit 31 to 0 Data signal of SHARED_DRAM"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_axilite {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x18 layer_width_V W 0x0 "Data signal of layer_width_V" {{0 9 layer_width_V W 0 "Bit 8 to 0 Data signal of layer_width_V"} {9 23 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 layer_height_V W 0x0 "Data signal of layer_height_V" {{0 9 layer_height_V W 0 "Bit 8 to 0 Data signal of layer_height_V"} {9 23 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 layer_channels_in_V W 0x0 "Data signal of layer_channels_in_V" {{0 10 layer_channels_in_V W 0 "Bit 9 to 0 Data signal of layer_channels_in_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 layer_channels_out_V W 0x0 "Data signal of layer_channels_out_V" {{0 10 layer_channels_out_V W 0 "Bit 9 to 0 Data signal of layer_channels_out_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 layer_kernel_V W 0x0 "Data signal of layer_kernel_V" {{0 2 layer_kernel_V W 0 "Bit 1 to 0 Data signal of layer_kernel_V"} {2 30 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 layer_stride_V W 0x0 "Data signal of layer_stride_V" {{0 2 layer_stride_V W 0 "Bit 1 to 0 Data signal of layer_stride_V"} {2 30 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 layer_pad W 0x0 "Data signal of layer_pad" {{0 1 layer_pad W 0 "Bit 0 to 0 Data signal of layer_pad"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 layer_relu W 0x0 "Data signal of layer_relu" {{0 1 layer_relu W 0 "Bit 0 to 0 Data signal of layer_relu"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 layer_is_first_split_layer W 0x0 "Data signal of layer_is_first_split_layer" {{0 1 layer_is_first_split_layer W 0 "Bit 0 to 0 Data signal of layer_is_first_split_layer"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 layer_is_second_split_layer W 0x0 "Data signal of layer_is_second_split_layer" {{0 1 layer_is_second_split_layer W 0 "Bit 0 to 0 Data signal of layer_is_second_split_layer"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 layer_global_pool W 0x0 "Data signal of layer_global_pool" {{0 1 layer_global_pool W 0 "Bit 0 to 0 Data signal of layer_global_pool"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 layer_mem_addr_input_V W 0x0 "Data signal of layer_mem_addr_input_V" {{0 23 layer_mem_addr_input_V W 0 "Bit 22 to 0 Data signal of layer_mem_addr_input_V"} {23 9 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 layer_mem_addr_output_V W 0x0 "Data signal of layer_mem_addr_output_V" {{0 23 layer_mem_addr_output_V W 0 "Bit 22 to 0 Data signal of layer_mem_addr_output_V"} {23 9 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 layer_mem_addr_weights_V W 0x0 "Data signal of layer_mem_addr_weights_V" {{0 23 layer_mem_addr_weights_V W 0 "Bit 22 to 0 Data signal of layer_mem_addr_weights_V"} {23 9 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 weights_offset W 0x0 "Data signal of weights_offset" {{0 32 weights_offset W 0 "Bit 31 to 0 Data signal of weights_offset"}}} {0x90 num_weights_V W 0x0 "Data signal of num_weights_V" {{0 19 num_weights_V W 0 "Bit 18 to 0 Data signal of num_weights_V"} {19 13 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 input_offset W 0x0 "Data signal of input_offset" {{0 32 input_offset W 0 "Bit 31 to 0 Data signal of input_offset"}}}}
        memories "layer_name {base_address 16 range 8}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_axilite m_axi_memorybus"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_memorybus {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_memorybus"
        data_width "32"
        param_prefix "C_M_AXI_MEMORYBUS"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 353 II x}
...
set enable_xo_gen 0
set kernel_files {/home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/weights_cache.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/unittests.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/processing_element.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/output_cache.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/network.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/netconfig.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/memory_controller.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/image_cache.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/gpool_cache.cpp /home/wenshuran/hdcourse/zynqnet-master/_HLS_CODE/fpga_top.cpp}
if {$enable_xo_gen} {
