...
#ifndef __fpga_top_mul_16s_2ns_16_3__HH__
#define __fpga_top_mul_16s_2ns_16_3__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpga_top_mul_16s_2ns_16_3) {
    ...
    SC_CTOR(fpga_top_mul_16s_2ns_16_3):  ACMP_mul_su_U ("ACMP_mul_su_U") {
