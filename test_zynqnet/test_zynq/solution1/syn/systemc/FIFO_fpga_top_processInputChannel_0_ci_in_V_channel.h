...
#ifndef FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_HH_
#define FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_HH_

#include <systemc>
using namespace std;
SC_MODULE(FIFO_fpga_top_processInputChannel_0_ci_in_V_channel) {
    static const unsigned int DATA_WIDTH = 10;
    static const unsigned int ADDR_WIDTH = 1;
    static const unsigned int FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_depth = 2;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_depth];
    ...
    SC_CTOR(FIFO_fpga_top_processInputChannel_0_ci_in_V_channel) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_depth; i++) {
    ...
    ~FIFO_fpga_top_processInputChannel_0_ci_in_V_channel() {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_depth) {
...
#endif //FIFO_fpga_top_processInputChannel_0_ci_in_V_channel_HH_
