...
#ifndef __fpga_top_GBRAM_0_H__
#define __fpga_top_GBRAM_0_H__
...
struct fpga_top_GBRAM_0_ram : public sc_core::sc_module {
...
fpga_top_GBRAM_0_ram* meminst;


SC_CTOR(fpga_top_GBRAM_0) {
meminst = new fpga_top_GBRAM_0_ram("fpga_top_GBRAM_0_ram");
