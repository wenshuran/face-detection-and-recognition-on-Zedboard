...
HD_PWD='/home/wenshuran/hdcourse/test_zynqnet/zynqnet_vivado/zynqnet_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_top_ap_fadd_3_full_dsp_32.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fpga_top_ap_fadd_3_full_dsp_32.tcl -notrace
