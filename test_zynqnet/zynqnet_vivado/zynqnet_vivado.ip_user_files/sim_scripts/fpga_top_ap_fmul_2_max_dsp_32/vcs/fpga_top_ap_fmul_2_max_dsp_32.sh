...
#
# Filename    : fpga_top_ap_fmul_2_max_dsp_32.sh
...
#
# Generated by Vivado on Wed May 29 00:59:59 PDT 2019
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-help]
# usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-lib_map_path]
# usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-noclean_files]
# usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-reset_run]
#
...
# executing this script. Please type 'fpga_top_ap_fmul_2_max_dsp_32.sh -help' for more information.
#
...
# Script info
echo -e "fpga_top_ap_fmul_2_max_dsp_32.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-help]\n\
Usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-lib_map_path]\n\
Usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-reset_run]\n\
Usage: fpga_top_ap_fmul_2_max_dsp_32.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./fpga_top_ap_fmul_2_max_dsp_32.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fpga_top_ap_fmul_2_max_dsp_32.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fpga_top_ap_fmul_2_max_dsp_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fpga_top_ap_fmul_2_max_dsp_32_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../../test_zynq/solution1/impl/ip/tmp.srcs/sources_1/ip/fpga_top_ap_fmul_2_max_dsp_32/sim/fpga_top_ap_fmul_2_max_dsp_32.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.fpga_top_ap_fmul_2_max_dsp_32 -o fpga_top_ap_fmul_2_max_dsp_32_simv
}
...
simulate()
{
  ...
  ./fpga_top_ap_fmul_2_max_dsp_32_simv $opts -do simulate.do
}
# Script usage
usage()
{
