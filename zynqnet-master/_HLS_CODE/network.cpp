...
network_t *get_network_config() {
  network_t *net = new network_t(27, 2000000);
  ...
  addLayer(net, layer_t("c10/p1",   8,   8,  736,  64, 1, 0, 1, 0,  1,  0,  1));
  addLayer(net, layer_t("c10/p2",   8,   8,  736,  64, 1, 0, 1, 0,  0,  1,  1));

  net->num_weights = 2000000;
