...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ov7670_decode_stream_0
 PARAMETER compatible = xlnx,ov7670-decode-stream-1.0
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = vdma_mm2s
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_vdma
 PARAMETER HW_INSTANCE = vdma_s2mm
 PARAMETER interrupt-parent = intc
